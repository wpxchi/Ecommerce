...
const Bottomnavbar = () => {
  return (
    <div className="bg-gray-400 dark:bg-gray-800 p-2 fixed bottom-0 left-1/2 transform -translate-x-1/2 flex justify-around items-center rounded-md">
      <Link to={"/"} className="hover:bg-gray-500 dark:hover:bg-gray-700 p-1 rounded-md">
      ...
      <Link to={"/Favorites"} className="hover:bg-gray-500 dark:hover:bg-gray-700 p-1 rounded-md">
        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <Link to={"/Cart"} className="hover:bg-gray-500 dark:hover:bg-gray-700 p-1 rounded-md">
        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <Link to={"/Profile"} className="hover:bg-gray-500 dark:hover:bg-gray-700 p-1 rounded-md">
        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
